const Card = () => {
    ...
    <div className="mx-2 mb-5">
        <h1 className="text-center pt-10 pb-10 font-bold text-4xl">
        Mencari Pengalaman Liburan dari Sini
        </h1>
    <div className="flex gap-5">
        <div className="max-w-sm  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-70">
        <a href="#">
        <img class="rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image.jpg" alt="" />
    </a>
    <div className="p-5">
        <a href="#">
