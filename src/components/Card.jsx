        ...
        <section className="bg-black">
          ...
          <div className=" grid grid-cols-2 h-screen bg-black-100 flex">
            ...
            <div className="bg-black-500 p-4">
              ...
              <p className="text-base text-white">2 TAMU - 1 KAMAR TIDUR - 1 TEMPAT TIDUR - 1 KAMAR MANDI</p>
            ...
            <div className=" flex bg-black justify-center">
              ...
              <div className="p-6 border rounded-md bg-white w-1/2 h-3/4">
                
                <h2 className="text-2xl font-semibold mb-4">{cardData.price}</h2>
                
                <div className="grid grid-cols-4 grid-rows-2 h-40">

                  <div className="col-span-2 border-2 border-black rounded-tl-lg">1</div>
                  <div className="col-span-2 border-2 border-black rounded-tr-lg ">2</div>
                  <div className="col-span-4 border-2 border-black rounded-b-lg">3</div>
                  
                </div>
                
                <button className="bg-blue-500 text-white px-4 py-2 rounded-3xl mx-auto w-full mt-5">Tombol</button>
              </div>
            </div>
